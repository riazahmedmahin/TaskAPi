...
export const DATABASE= 'mongodb+srv://riazahmedmahin:mahin60@cluster0.ihs08.mongodb.net/TaskApi?retryWrites=true&w=majority&appName=Cluster0'
...
export const EMAIL_SECURITY = 25;
export const EMAIL_URLS = "info@teamrabbil.com";
export const EMAIL_PASS = "~sR4[bhac[Qs";
export const UN_AUTH = "flse";
